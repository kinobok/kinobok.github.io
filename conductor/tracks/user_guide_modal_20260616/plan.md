# Implementation Plan: User Guide Modal & Empty State Handling

## Phase 1: Core Logic & Error Handling [checkpoint: ccf4c2e]
- [x] Task: Update CSV parsing logic to handle and report invalid schemas
    - [x] Sub-task: Write Tests
    - [x] Sub-task: Implement Feature
- [x] Task: Conductor - User Manual Verification 'Phase 1: Core Logic & Error Handling' (Protocol in workflow.md)

## Phase 2: Guidance Modal UI [checkpoint: 8fd0162]
- [x] Task: Create `GuidanceModal` component with instructions and upload button
    - [x] Sub-task: Write Tests
    - [x] Sub-task: Implement Feature
